...
for element in all_price_elements:
    try:
        ...
        price = soup.select(".list-card-details li")
    finally:
...
for n in range(len(all_links)):
    driver.get("https://docs.google.com/forms/d/e/1FAIpQLSdy_Efx3oGgPxKQpJIGDCyaB3Z_BG2YShyONJ-JIyWRTRkuZg/viewform?usp=sf_link")
